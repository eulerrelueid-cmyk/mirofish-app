  ...
  const statItems = [
    {
      ...
      detail: 'Total modeled participants',
    ...
    },
    {
      ...
      detail: 'Visible output across the run',
    ...
    },
    {
      ...
      detail: 'Recorded interaction events',
    ...
    },
    {
      ...
      detail: 'How closely positions converged',
      color: 'text-sky-300',
    ...
    },
    {
      ...
      detail: 'Connections formed during the run',
      color: 'text-miro-accent',
      bgColor: 'bg-miro-accent/15',
    },
    {
